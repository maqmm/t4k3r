...
2. Написать в любом чате (лучше другу без премиума) `.add <ссылка на набор>`, чтобы добавить набор в список эмодзи профиля, а если набор адаптивный, то ещё написать `.addbg <ссылка на набор>`, чтобы добавить набор в список фонов профиля и сообщений.
